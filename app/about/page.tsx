...
export default function AboutPage() {
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 p-8 max-w-3xl mx-auto w-full z-10">
        <div className="bg-background p-8 rounded-lg border">
          ...
          <div className="space-y-6 text-muted-foreground">
            ...
            <p>
              I specialize in creating responsive, user-friendly interfaces and robust backend systems. My passion lies
              at the intersection of technology and creativity, where I can leverage both technical expertise and design
